...
-- Your code here
SELECT cats.name, owners.first_name FROM cats
...
-- Your code here
SELECT owners.first_name, owners.last_name, cats.name, cats.birth_year FROM cats
JOIN cat_owners ON (cats.id = cat_owners.cat_id)
JOIN owners ON (owners.id = cat_owners.owner_id)
...
-- Your code here
SELECT owners.first_name, owners.last_name, cats.name FROM cats
JOIN cat_owners ON (cats.id = cat_owners.cat_id)
JOIN owners ON (owners.id = cat_owners.owner_id)
